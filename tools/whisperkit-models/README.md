...
| `NbAiLab_nb-whisper-large-verbatim` | `NbAiLab/nb-whisper-large-verbatim` (Norwegian no+nn) | `9e28cb1f991a` | 2.96 GB | 1.14 — the verbatim variant does not collapse to <\|nocaptions\|>; lower-case only |
